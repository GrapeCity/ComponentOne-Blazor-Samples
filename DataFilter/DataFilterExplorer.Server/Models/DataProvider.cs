...
namespace DataFilterExplorer.Server
{
    internal class DataProvider
    {
        ...
        public static DataTable GetCarTable()
        {
            ...
            using (var s = asm.GetManifestResourceStream("DataFilterExplorer.Server.Data.cars.xml"))
            {
                _= dt.ReadXml(s);
            }
            return dt;
        ...
        {
            var asm = Assembly.GetExecutingAssembly();
            using (var stream = asm.GetManifestResourceStream("DataFilterExplorer.Server.Data.Stores.txt"))
            {
