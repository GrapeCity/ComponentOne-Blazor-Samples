...
window.popupContent = function (content, title, isHTML, forceNewWindow) {
    ...
    saveFile(content, title, newWindow);
    if (isHTML) {
...
*/
window.saveFile = function (fileContent, filePath, _window) {
    ...
    if (!_window || _window == window) {
        ...
        var html = '<script src="scripts.js"></script><script>saveFile(' + JSON.stringify(fileContent) + ',"' + filePath + '");</script>';
